// Nodejs me module ka matlab file 

// Let see how to import NPM modules 

// const color = require('cli-color') // this is how we load the npm module 

// console.log(color.blue('Neela color'))
// console.log(color.yellow('Neela color'))
// console.log(color.red('Neela color'))
...
// The above function is an anynomus function which is immideately invoked and called 

// lets see how to make our own local module 
